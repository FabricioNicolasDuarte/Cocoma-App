<nav x-data="{ open: false }" class="bg-slate-900/80 backdrop-blur-sm border-b border-slate-700/80 relative z-40">
            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}">
                        <img src="{{ asset('images/logobarra.png') }}" alt="Icono Cocoma" class="block h-9 w-auto" />
                    </a>
                </div>
